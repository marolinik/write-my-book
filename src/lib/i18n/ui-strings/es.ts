...
export const ES: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Análisis de estilo, lectura del manuscrito, control de continuidad, análisis de mercado.",
    roleCoachDesc: "Entrenador de escritura que orquesta flujos de varios pasos.",
    roleCreativeDesc: "Arquitectura de la historia, planificación de escenas, lluvia de ideas creativa.",
    addKey: "Añadir clave",
    provider: "Proveedor",
