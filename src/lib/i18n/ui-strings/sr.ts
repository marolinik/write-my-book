...
export const SR: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Analiza stila, čitanje rukopisa, provera kontinuiteta, analiza tržišta.",
    roleCoachDesc: "Trener pisanja koji vodi višekorakne tokove.",
    roleCreativeDesc: "Arhitektura priče, planiranje scena, kreativno smišljanje.",
    addKey: "Dodaj ključ",
    provider: "Provajder",
