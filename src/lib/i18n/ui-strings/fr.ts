...
export const FR: UIStrings = {
  ...
  settings: {
    ...
    localFleet: "Flotte locale (auto-hébergée)",
    roleGhostwriterDesc: "Écrit les chapitres, planifie les plans, construit l’architecture du récit.",
    roleEditorDesc: "Édition structurelle, édition de style, suggestions de révision.",
    roleBetaReaderDesc: "Panel de lecteurs simulés fournissant des retours.",
    roleAnalystDesc: "Nombre de mots, lisibilité et contrôles de publication.",
    roleCoachDesc: "Coach d’écriture qui orchestre des flux en plusieurs étapes.",
    roleCreativeDesc: "Architecture du récit et mouvements structurels.",
    roleStylistDesc: "Capte l'empreinte vocale à partir de laquelle tout brouillon ultérieur est écrit.",
    rolePlannerDesc: "Transforme un chapitre en feuille de beats avant toute prose.",
    roleReaderDesc: "Lit le manuscrit entier et le recoupe : continuité, carte des chapitres.",
    roleResearchDesc: "Recherche de monde et comparables de marché — les agents qui quittent le manuscrit pour le web.",
  ...
  setup: {
    ...
    genreOptional: "Genre (optionnel)", descriptionOptional: "Description (optionnel)", descriptionPlaceholder: "Un bref résumé de votre livre...",
  ...
  bookSettings: {
    ...
    creative: "Créatif", creativeDesc: "Architecture du récit",
    editor: "Éditeur", editorDesc: "Édition de développement et de ligne",
    betaReader: "Lecteur bêta", betaReaderDesc: "Panel de lecteurs simulé",
    stylist: "Styliste", stylistDesc: "Capte votre voix",
    planner: "Planificateur", plannerDesc: "Transforme un chapitre en beats",
    reader: "Lecteur", readerDesc: "Lecture intégrale et continuité",
    research: "Recherche", researchDesc: "Recherche de monde et de marché",
    analyst: "Analyste", analystDesc: "Statistiques, lisibilité et contrôles de publication",
    ...
    sourceBookRole: "surcharge de rôle du livre",
    sourceBookDefault: "valeur par défaut du livre",
    sourceGlobalRole: "surcharge de rôle globale",
    sourceGlobalDefault: "valeur par défaut globale",
  ...
  editorUI: {
    ...
    groupFormatting: "Mise en forme",
    groupHeadings: "Titres",
    groupLists: "Listes et blocs",
    ...
    ghostTextOn: "Texte fantôme IA (activé)",
    ghostTextOff: "Texte fantôme IA (désactivé)",
    toggleFindings: "Afficher ou masquer les constats",
    toggleFindingsPending: "Afficher ou masquer les constats, {count} en attente",
  ...
  batchEditorial: {
    ...
    capRange: "Saisissez un plafond budgétaire entre {min} et {max}.",
    run: "Lancer",
    status: "État du lot",
    history: "Exécutions précédentes",
    historyEmpty: "Aucune exécution sur le livre entier n'est encore terminée. Celles que vous mettez en file apparaîtront ici avec leur coût.",
    historyError: "La liste des exécutions précédentes n'a pas pu être chargée.",
    historyRunning: "En cours",
    historyScheduled: "Programmée",
    historyDone: "Terminée",
    historyHalted: "Arrêtée",
    historyFailed: "Échouée",
    historyChapterRange: "Ch. {a} à {b}",
    historyWholeBook: "Livre entier",
    historyProgress: "{done} sur {total} faits",
    historyFailures: "{n} en échec",
    historySpend: "{spent} sur {cap}",
    historySpendNoCap: "{spent} dépensé",
    historyHaltedBecause: "Arrêtée : {reason}",
    haltCancelled: "vous l'avez arrêté",
  ...
  reportsUI: {
    ...
    yourKeys: "Vos clés",
    platformKeys: "Clés de la plateforme",
    ...
    discardedGenerations: "Votre fournisseur a aussi facturé {n} générations que ce produit a jetées, environ {cost}. Elles ne sont pas comptées ci-dessus : une limite a été atteinte ou l'attente a été annulée après que le modèle avait déjà produit le texte.",
  },
  ...
  bookUI: {
    ...
    unpinFromDashboard: "Détacher du tableau de bord",
    pinBook: "Épingler le livre",
    unpinBook: "Détacher le livre",
    ...
    rewardUnlockedNamed: "🎉 Débloqué : {reward} !",
    rewardUnlockAt: "🔒 Débloqué à : {target}",
    keepWriting: "Continuez à écrire !",
    viewList: "Liste",
    viewCanvas: "Canevas",
    viewPipeline: "Pipeline",
    viewCorkboard: "Tableau",
    lifeKeepGoing: "{k}K mots — continuez !",
    lifeNovella: "{k}K mots — une solide novella",
    lifeAlmostNovel: "{k}K mots — presque un roman",
    lifeNovels: "L’équivalent de {n} romans en mots",
    mileFirstDraft: "🎉 Premier jet terminé !",
    mileEditing: "✨ Révision terminée !",
    mileBetaPassed: "🏆 Lecture bêta validée !",
    mileProgress: "📖 Progression d’écriture",
    shareStats: "{words} mots | {done}/{total} chapitres | {days} jours",
    wrappedShare: "Mon année {year} en écriture :",
    wrappedShareStats: "{words} mots | série de {days} jours | {personality}",
    certShare: "🏆 J’ai terminé le premier jet de « {book} » !",
    healthDrafting: "Progression du premier jet",
    healthEditorial: "Couverture éditoriale",
    healthBeta: "Validation bêta",
    healthFindings: "Santé des constats",
    healthFoundation: "Fondations",
    healthEditedDetail: "{done}/{total} chapitres révisés",
    healthBetaDetail: "{done}/{total} chapitres validés",
    foundStyle: "Style",
    foundBible: "Bible",
    foundArchitecture: "Architecture",
    notifStreakRisk: "Votre série de {days} jours est en danger !",
    notifStreakDetail: "Écrivez ne serait-ce que 50 mots pour la préserver.",
    notifFindings: "{count} constats en attente d’examen",
    notifFindingsDetail: "Vos éditeurs ont des suggestions prêtes.",
    notifStale: "{chapter} — {days} jours sans modification",
    notifStatus: "Statut : {status}",
    timeMorning: "Écrivain du matin",
    timeAfternoon: "Auteur de l’après-midi",
    timeEvening: "Conteur du soir",
    timeNight: "Oiseau de nuit",
    rewardMidnight: "Thème minuit",
    rewardMidnightDesc: "Thème d’éditeur bleu profond",
    rewardForest: "Thème forêt",
    rewardForestDesc: "Thème nature vert foncé",
    rewardSunrise: "Thème lever de soleil",
    rewardSunriseDesc: "Thème matinal orange chaleureux",
    rewardGalaxy: "Thème galaxie",
    rewardGalaxyDesc: "Thème cosmique violet-bleu",
    rewardThunder: "Orage",
    rewardThunderDesc: "Ambiance d’orage",
    rewardSpace: "Espace profond",
    rewardSpaceDesc: "Bourdonnement spatial d’ambiance",
    rewardGaramondDesc: "Police d’édition classique",
    rewardLiterataDesc: "Police de Google optimisée pour le livre",
    rewardNovelist: "Romancier",
    rewardNovelistDesc: "Terminez un manuscrit de 50K+ mots",
    rewardIronWriter: "Écrivain de fer",
    rewardIronWriterDesc: "30 jours d’écriture d’affilée",
    achFirstWords: "Premiers mots",
    achFirstWordsDesc: "Écrivez vos 100 premiers mots",
    achGettingStarted: "Les débuts",
    achGettingStartedDesc: "Écrivez 1 000 mots",
    achSerious: "Écrivain sérieux",
    achSeriousDesc: "Écrivez 10 000 mots",
    achNaNo: "NaNoWriMo !",
    achNaNoDesc: "Écrivez 50 000 mots (un roman entier !)",
    achProlific: "Auteur prolifique",
    achProlificDesc: "Écrivez 100 000 mots",
    achOnRoll: "Sur sa lancée",
    achOnRollDesc: "Écrivez 3 jours d’affilée",
    achWeek: "Guerrier de la semaine",
    achWeekDesc: "Écrivez 7 jours d’affilée",
    achMonthly: "Maître du mois",
    achMonthlyDesc: "Écrivez 30 jours d’affilée",
    achChapterOne: "Chapitre un",
    achChapterOneDesc: "Terminez votre premier chapitre",
    achFirstDraft: "Premier jet bouclé",
    achFirstDraftDesc: "Rédigez tous les chapitres",
    achReaderApproved: "Approuvé par les lecteurs",
    achReaderApprovedDesc: "Validez la lecture bêta sur tous les chapitres",
    achSprint: "Maître du sprint",
    achSprintDesc: "Écrivez 500+ mots en une seule session",
    achEditorialEye: "Œil éditorial",
    achEditorialEyeDesc: "Examinez 50+ constats éditoriaux",
  ...
  agentUI: {
    ...
    queuedForBackground: "{workflow} mis en file pour un traitement en arrière-plan",
    navigateAwayHint: "Vous pouvez quitter la page — le traitement continue.",
    ctaReviewFindings: "Examiner les constats",
    ctaOpenChapter: "Ouvrir le chapitre {n}",
    ctaContinueSetup: "Poursuivre la configuration",
    ctaViewDocuments: "Voir les documents",
    ctaViewReports: "Voir les rapports",
    apiKeyHint: "Ajoutez votre clé d’API dans les Réglages pour utiliser les agents IA.",
    workflowCompleted: "{workflow} terminé",
    backgroundDone: "Tâche en arrière-plan terminée avec succès",
    viewResults: "Voir les résultats",
    viewInPanel: "Voir les résultats dans le panneau de l’agent",
    addedToQueue: "« {workflow} » ajouté à la file",
    quickFreewrite: "Écriture libre",
    quickAskCoach: "Demander au coach",
    ...
    costFromRuns: "D'après les {n} dernières exécutions de cette passe sur ce livre.",
    costFromTable: "Une estimation au tarif des modèles. Elle s'affine une fois que ce livre a fait la passe quelques fois.",
  },
  ...
  editorialUI: {
    ...
    settleDisabledTitle: "En attente de la réponse de l’éditeur — annulez le tour pour décider maintenant",
    ...
    quickTake: "Réponse rapide",
    consideredTake: "Qu'il y réfléchisse",
    takeHint: "Une réponse rapide saute la phase de réflexion du modèle. Elle arrive en quelques secondes et reste plus superficielle.",
    actionApplied: "{category} appliqué — « {text} » remplacé",
    actionAppliedNoText: "{category} appliqué",
    actionDismissed: "{category} écarté",
    actionDismissedBecause: "{category} écarté — {reason}",
    actionUndoneReverted: "Annulé : {category}, le texte est revenu",
    actionUndoneKept: "Annulé : {category}, le texte est resté tel quel",
    actionSessionDone: "{workflow} : {countNoun}",
    actionSessionDoneRejected: "{workflow} : {countNoun}, {rejected} rejetés",
    actionUnknown: "Une action antérieure que cette version ne sait pas décrire",
    findingOne: "observation",
    findingFew: "observations",
    findingMany: "observations",
    ...
    fixNotHeld: "Le passage modifié semble toujours présenter le problème signalé par cette note. Relisez-le ou annulez la modification.",
    fixHeld: "Vérifié : la modification a supprimé ce que signalait cette note.",
  },

  editorChrome: {
    stillWriting: "Écrit encore…",
    rewriteComparison: "Comparaison de la réécriture IA",
    noPreviousChapter: "Aucun chapitre précédent",
    noNextChapter: "Aucun chapitre suivant",
    serverTiming: "serveur {seconds}s",
    ...
    soundRain: "Pluie",
    soundCoffee: "Café",
    soundLibrary: "Bibliothèque",
    soundFireplace: "Cheminée",
    soundForest: "Forêt",
    soundOcean: "Océan",
    annInsertion: "Insertion",
    annDeletion: "Suppression",
    annComment: "Commentaire",
    annAiSuggestion: "Suggestion IA",
    annFinding: "Constat éditorial",
    annHighSeverity: "Gravité élevée",
    annMediumSeverity: "Gravité moyenne",
    annLowSeverity: "Gravité faible",
    annContinuity: "Continuité",
    legendAiSuggestionDesc: "Contient un texte de remplacement",
    legendFindingDesc: "À examiner",
    legendAcceptedChange: "Modification acceptée",
    legendAcceptedDesc: "Texte inséré",
    legendDeletionDesc: "Texte barré",
    legendCommentDesc: "Note en ligne",
    replacedAcross: "{count} remplacés dans {chapters}.",
    tryAgainHint: "Veuillez réessayer.",
    scopeThisChapter: "Ce chapitre",
    scopeWholeBook: "Tout le livre",
    keyboardHint: "Entrée pour envoyer · Maj+Entrée pour une nouvelle ligne",
    focusNormalDesc: "Tout est visible",
    focusFocusedDesc: "Barre latérale et en-tête atténués",
    focusParagraphDesc: "Paragraphe courant mis en avant",
    inlineRewrite: "Réécrire",
    inlineImprove: "Améliorer",
    inlineShorten: "Raccourcir",
    inlineExtend: "Étoffer",
    inlineRevise: "Réviser",
    inlineMoreDialogue: "Plus de dialogue",
    inlineMoreVivid: "Plus imagé",
    inlineMoreFormal: "Plus formel",
    chapterPlaceholder: "Commencez à écrire votre chapitre...",
    conflictNewerVersion: "Quelqu’un d’autre (agent, import ou onglet) a enregistré une version plus récente. Votre texte reste dans cet éditeur — examinez-le pour reprendre l’enregistrement.",
    offlineKept: "Vous êtes hors ligne. Votre texte est conservé sur cet appareil et sera synchronisé dès la reconnexion.",
    conflictPreserved: "L’autre version est conservée dans l’historique des versions.",
    conflictChangedAgain: "{doc} a encore changé",
    conflictDiffUpdated: "Les différences ont été mises à jour — veuillez vérifier une fois de plus.",
    versionManual: "Manuel",
    versionRestore: "Restauration",
  ...
  importExportUI: {
    ...
    devicePrint: "Impression (6×9)",
    devicePhone: "Téléphone",
    formatPlainText: "Texte brut",
    mergedSuffix: "(fusionné)",
    readyChaptersDrafted: "Chapitres rédigés",
    readyChaptersEdited: "Chapitres révisés",
    readyBetaReading: "Lecture bêta",
    readyPendingFindings: "Constats en attente",
    readyFingerprint: "Empreinte stylistique",
    readyStoryBible: "Bible de l’histoire",
    readyDraftedDetail: "{done}/{total} chapitres rédigés",
    readyEditedAll: "Tous les chapitres ont été révisés",
    readyEditedSome: "{count} chapitres doivent être révisés",
    readyBetaAll: "Tous les chapitres ont passé la lecture bêta",
    readyBetaSome: "{done}/{total} chapitres validés en lecture bêta",
    readyFindingsNone: "Aucun constat non traité",
    readyFindingsSome: "{count} constats à examiner",
    readyFingerprintYes: "Empreinte stylistique capturée",
    readyFingerprintNo: "Aucune empreinte stylistique — la voix de l’IA peut manquer de cohérence",
    readyBibleYes: "Bible de l’histoire créée",
    readyBibleNo: "Aucune bible de l’histoire — pensez à en créer une avant l’export",
    formatDocxDesc: "Format Microsoft Word, idéal pour la révision et les soumissions",
    formatPdfDesc: "Prêt à imprimer via le moteur Typst, avec une typographie professionnelle",
    formatEpubDesc: "EPUB3 pour liseuses et distribution numérique",
    importDocxDesc: "Meilleure détection des chapitres. Conserve la mise en forme.",
    importMarkdownDesc: "Format natif. Les titres de chapitre sont détectés automatiquement.",
    importTxtDesc: "Chapitres séparés par des lignes vides ou des titres.",
  },
  ...
  onboardingUI: {
    ...
    costHintAnthropic: "Modèles Claude, à partir de 0,25 $ par 1M de tokens",
    costHintOpenrouter: "Plus de 200 modèles, Claude à partir de 0,25 $ par 1M de tokens",
    costHintOpenai: "Modèles GPT-4o et o3, à partir de 0,15 $ par 1M de tokens",
    costHintGemini: "Gemini 2.5 Pro et Flash, à partir de 0,075 $ par 1M de tokens",
    costHintGrok: "Grok-4 et Grok-3, à partir de 3 $ par 1M de tokens",
  },
  ...
  pagesUI: {
    ...
    bookNamed: "Livre : {book}",
    seriesWide: "Toute la série",
    metaNotFound: "Introuvable",
    metaSnapshot: "{book} — Instantané",
    metaEditorialBrief: "{book} — Rapport éditorial",
    setupFailed: "Impossible de terminer la configuration : {error}",
    setupSavedNoChapter: "Configuration enregistrée, mais le premier chapitre n’a pas pu être ouvert : {error}",
    alertFindingsNeedReview: "{count} constats à examiner",
    alertBetaFailed: "Échec de la lecture bêta sur {chapter} — {book}",
    seriesDuology: "Duologie (2 livres)",
    seriesTrilogy: "Trilogie (3 livres)",
    seriesTetralogy: "Tétralogie (4 livres)",
    seriesPentalogy: "Pentalogie (5 livres)",
    seriesSaga: "Saga (6+ livres)",
    seriesOpenEnded: "Série ouverte",
    docPlaceholder: "Commencez à écrire...",
    conflictSafeHint: "Vos modifications sont en sécurité — examinez les changements pour les fusionner.",
