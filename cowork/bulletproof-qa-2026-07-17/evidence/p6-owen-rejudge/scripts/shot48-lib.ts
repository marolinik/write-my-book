/**
* 48-series shared harness (verbatim copy of the P1 47-series lib, kept in this
 * persona dir so P6 evidence is self-contained; see p1-maya-rejudge/scripts/shot47-lib.ts)
 *
 * Original header: 47-series shared harness — the D-176 wait chrome, on camera.
 *
