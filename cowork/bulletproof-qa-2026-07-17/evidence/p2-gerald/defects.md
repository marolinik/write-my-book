...
The bug is format-agnostic (`combinedMd` assembly happens before the docx/pdf/epub branch), so pdf and epub exports are very likely equally affected — not independently verified, flagging for follow-up.
