...
export const RU: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Анализ стиля, чтение рукописи, проверка непротиворечивости, анализ рынка.",
    roleCoachDesc: "Наставник по письму, управляющий многошаговыми процессами.",
    roleCreativeDesc: "Архитектура истории, планирование сцен, креативный мозговой штурм.",
