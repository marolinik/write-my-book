...
export const DE: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Wortzahlen, Lesbarkeit und Veröffentlichungsprüfungen.",
    roleCoachDesc: "Schreibcoach, der mehrstufige Workflows steuert.",
    roleCreativeDesc: "Story-Architektur und strukturelle Eingriffe.",
    roleStylistDesc: "Erfasst den Stimm-Fingerabdruck, aus dem jeder spätere Entwurf geschrieben wird.",
    rolePlannerDesc: "Macht aus einem Kapitel ein Beat-Sheet, bevor Prosa entsteht.",
    roleReaderDesc: "Liest das ganze Manuskript und gleicht es ab: Kontinuität, Kapitelübersicht.",
    roleResearchDesc: "Weltrecherche und Marktvergleiche — die Agenten, die das Manuskript für das Web verlassen.",
  ...
  setup: {
    ...
    genreOptional: "Genre (optional)", descriptionOptional: "Beschreibung (optional)", descriptionPlaceholder: "Eine kurze Zusammenfassung Ihres Buches...",
  ...
  bookSettings: {
    ...
    creative: "Kreativ", creativeDesc: "Story-Architektur",
    editor: "Lektor", editorDesc: "Entwicklungs- & Zeilenredaktion",
    betaReader: "Beta-Leser", betaReaderDesc: "Simuliertes Leser-Panel",
    stylist: "Stilist", stylistDesc: "Erfasst deine Stimme",
    planner: "Planer", plannerDesc: "Macht aus einem Kapitel Beats",
    reader: "Leser", readerDesc: "Gesamtlektüre & Kontinuität",
    research: "Recherche", researchDesc: "Welt- und Marktrecherche",
    analyst: "Analyst", analystDesc: "Statistik, Lesbarkeit & Veröffentlichungsprüfungen",
  ...
  batchEditorial: {
    ...
    run: "Starten",
    status: "Stapelstatus",
    history: "Frühere Läufe",
    historyEmpty: "Noch ist kein Lauf über das ganze Buch fertig. Die Läufe, die du einreihst, erscheinen hier samt Kosten.",
    historyError: "Die Liste früherer Läufe konnte nicht geladen werden.",
    historyRunning: "Läuft",
    historyScheduled: "Geplant",
    historyDone: "Fertig",
    historyHalted: "Gestoppt",
    historyFailed: "Fehlgeschlagen",
    historyChapterRange: "Kap. {a} bis {b}",
    historyWholeBook: "Ganzes Buch",
    historyProgress: "{done} von {total} fertig",
    historyFailures: "{n} fehlgeschlagen",
    historySpend: "{spent} von {cap}",
    historySpendNoCap: "{spent} ausgegeben",
    historyHaltedBecause: "Gestoppt: {reason}",
    haltCancelled: "du hast ihn gestoppt",
  ...
  agentUI: {
    ...
    costFromRuns: "Auf Basis der letzten {n} Läufe dieses Durchgangs in diesem Buch.",
    costFromTable: "Eine Schätzung nach Modellpreisen. Sie wird genauer, sobald dieses Buch den Durchgang einige Male gelaufen ist.",
  },
  ...
  editorialUI: {
    ...
    actionApplied: "{category} übernommen — „{text}“ ersetzt",
    actionAppliedNoText: "{category} übernommen",
    actionDismissed: "{category} verworfen",
    actionDismissedBecause: "{category} verworfen — {reason}",
    actionUndoneReverted: "Rückgängig: {category}, der Text ist zurück",
    actionUndoneKept: "Rückgängig: {category}, der Text blieb unverändert",
    actionSessionDone: "{workflow}: {countNoun}",
    actionSessionDoneRejected: "{workflow}: {countNoun}, {rejected} abgelehnt",
    actionUnknown: "Eine frühere Aktion, die diese Version nicht beschreiben kann",
    findingOne: "Befund",
    findingFew: "Befunde",
    findingMany: "Befunde",
    triageTitle: "Was am meisten bringt",
    triageRest: "Die anderen {n} anzeigen",
