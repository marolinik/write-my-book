...
export const FR: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Analyse du style, lecture du manuscrit, vérification de la continuité, analyse du marché.",
    roleCoachDesc: "Coach d’écriture qui orchestre des flux en plusieurs étapes.",
    roleCreativeDesc: "Architecture du récit, planification des scènes, remue-méninges créatif.",
