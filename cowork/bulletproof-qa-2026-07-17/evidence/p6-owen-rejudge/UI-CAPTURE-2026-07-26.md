...
| `41c-p6-post-setup-overview.png` | Post-setup overview clean (progress cards, no broken/empty state) — the post-onboarding first-run experience the judge flagged as missing. |
