...
export const ZH: UIStrings = {
  ...
  settings: {
    ...
    localFleet: "本地集群（自托管）",
    roleGhostwriterDesc: "撰写章节、规划大纲、搭建故事结构。",
    roleEditorDesc: "结构编辑、语句编辑、修订建议。",
    roleBetaReaderDesc: "模拟读者小组，提供读者反馈。",
    roleAnalystDesc: "字数、可读性与出版检查。",
    roleCoachDesc: "写作教练，统筹多步骤工作流。",
    roleCreativeDesc: "故事结构与结构性调整。",
    roleStylistDesc: "捕捉声音指纹，之后的每一稿都据此写成。",
    rolePlannerDesc: "在动笔之前把一章拆成节拍表。",
    roleReaderDesc: "通读整部稿件并交叉比对：连贯性、章节地图。",
    roleResearchDesc: "世界观调研与市场对标——离开稿件走向网络的那几个智能体。",
    addKey: "添加密钥",
    provider: "提供商",
    labelOptional: "标签（可选）",
    apiKey: "API密钥",
  ...
  bookSettings: {
    ...
    creative: "创意", creativeDesc: "故事结构",
    editor: "编辑", editorDesc: "发展编辑与行编辑",
    betaReader: "测试读者", betaReaderDesc: "模拟读者面板",
    stylist: "文风师", stylistDesc: "捕捉你的声音",
    planner: "规划师", plannerDesc: "把一章拆成节拍",
    reader: "通读者", readerDesc: "全书通读与连贯性",
    research: "调研", researchDesc: "世界观与市场调研",
    analyst: "分析师", analystDesc: "统计、可读性与出版检查",
    ...
    sourceBookRole: "本书角色覆盖",
    sourceBookDefault: "本书默认",
    sourceGlobalRole: "全局角色覆盖",
  ...
  editorUI: {
    ...
    ghostTextOn: "AI 幽灵文本（开启）",
    ghostTextOff: "AI 幽灵文本（关闭）",
    toggleFindings: "显示或隐藏发现",
    toggleFindingsPending: "显示或隐藏发现，{count} 项待处理",
    chapterOnly: "仅本章",
    splitView: "分屏视图",
  ...
  bookUI: {
    ...
    unpinFromDashboard: "从仪表板取消固定",
    pinBook: "固定书籍",
    unpinBook: "取消固定书籍",
    forecastNeedsData: "再写几天就能生成预测",
    buildingPlan: "正在生成你的计划……",
    rewardUnlocked: "✅ 已解锁！",
    rewardUnlockedNamed: "🎉 已解锁：{reward}！",
    ...
    viewPipeline: "流水线",
    viewCorkboard: "软木板",
    lifeKeepGoing: "{k}K 字 — 继续加油！",
    lifeNovella: "{k}K 字 — 一部扎实的中篇",
    lifeAlmostNovel: "{k}K 字 — 快成一部长篇了",
    lifeNovels: "相当于 {n} 部长篇的字数",
    mileFirstDraft: "🎉 初稿完成！",
    mileEditing: "✨ 编辑完成！",
    mileBetaPassed: "🏆 Beta 试读通过！",
    mileProgress: "📖 写作进度",
    shareStats: "{words} 字 | {done}/{total} 章 | {days} 天",
    wrappedShare: "我的 {year} 年写作：",
    wrappedShareStats: "{words} 字 | 连续 {days} 天 | {personality}",
    certShare: "🏆 我完成了《{book}》的初稿！",
    healthDrafting: "初稿进度",
    healthEditorial: "编辑覆盖",
    healthBeta: "Beta 验证",
    healthFindings: "发现健康度",
    healthFoundation: "基础",
    healthEditedDetail: "{done}/{total} 章已编辑",
    healthBetaDetail: "{done}/{total} 章已通过",
    foundStyle: "文风",
    foundBible: "圣经",
    foundArchitecture: "结构",
    notifStreakRisk: "你的 {days} 天连续记录快中断了！",
    notifStreakDetail: "哪怕写 50 字也能保住它。",
    notifFindings: "{count} 条发现等待审阅",
    notifFindingsDetail: "你的编辑已准备好建议。",
    notifStale: "{chapter} — 已 {days} 天未动",
    notifStatus: "状态：{status}",
    timeMorning: "晨间写作者",
    timeAfternoon: "午后作家",
    timeEvening: "夜晚讲述者",
    timeNight: "夜猫子",
    rewardMidnight: "午夜主题",
    rewardMidnightDesc: "深蓝编辑器主题",
    rewardForest: "森林主题",
    rewardForestDesc: "深绿自然主题",
    rewardSunrise: "日出主题",
    rewardSunriseDesc: "温暖橙色晨间主题",
    rewardGalaxy: "星系主题",
    rewardGalaxyDesc: "宇宙紫蓝主题",
    rewardThunder: "雷暴",
    rewardThunderDesc: "雷雨环境音",
    rewardSpace: "深空",
    rewardSpaceDesc: "太空环境嗡鸣",
    rewardGaramondDesc: "经典出版字体",
    rewardLiterataDesc: "Google 为图书优化的字体",
    rewardNovelist: "长篇作家",
    rewardNovelistDesc: "完成 5 万字以上的稿件",
    rewardIronWriter: "铁人作家",
    rewardIronWriterDesc: "连续写作 30 天",
    achFirstWords: "第一批文字",
    achFirstWordsDesc: "写下你的前 100 字",
    achGettingStarted: "开个头",
    achGettingStartedDesc: "写下 1,000 字",
    achSerious: "认真的作者",
    achSeriousDesc: "写下 10,000 字",
    achNaNo: "NaNoWriMo！",
    achNaNoDesc: "写下 50,000 字（一部长篇！）",
    achProlific: "多产作家",
    achProlificDesc: "写下 100,000 字",
    achOnRoll: "势头正好",
    achOnRollDesc: "连续 3 天写作",
    achWeek: "周度战士",
    achWeekDesc: "连续 7 天写作",
    achMonthly: "月度大师",
    achMonthlyDesc: "连续 30 天写作",
    achChapterOne: "第一章",
    achChapterOneDesc: "完成你的第一章",
    achFirstDraft: "初稿完成",
    achFirstDraftDesc: "写完所有章节",
    achReaderApproved: "读者认可",
    achReaderApprovedDesc: "所有章节通过 Beta 试读",
    achSprint: "冲刺大师",
    achSprintDesc: "单次冲刺写下 500+ 字",
    achEditorialEye: "编辑之眼",
    achEditorialEyeDesc: "审阅 50+ 条编辑发现",
  ...
  agentUI: {
    ...
    timedOut: "已超时",
    agentSession: "代理会话",
    queuedForBackground: "{workflow} 已排入后台处理队列",
    navigateAwayHint: "你可以离开页面 — 处理会继续。",
    ctaReviewFindings: "查看发现",
    ctaOpenChapter: "打开第 {n} 章",
    ctaContinueSetup: "继续设置",
    ctaViewDocuments: "查看文档",
    ctaViewReports: "查看报告",
    apiKeyHint: "请在设置中添加 API 密钥以使用 AI 代理。",
    workflowCompleted: "{workflow} 已完成",
    backgroundDone: "后台任务已成功完成",
    viewResults: "查看结果",
    viewInPanel: "在代理面板中查看结果",
    addedToQueue: "已将“{workflow}”加入队列",
    quickFreewrite: "自由书写",
    quickAskCoach: "询问教练",
  ...
  editorChrome: {
    ...
    annDeletion: "删除",
    annComment: "批注",
    annAiSuggestion: "AI 建议",
    annFinding: "编辑发现",
    annHighSeverity: "高严重度",
    annMediumSeverity: "中等严重度",
    annLowSeverity: "低严重度",
    annContinuity: "连贯性",
    legendAiSuggestionDesc: "包含替换文本",
    legendFindingDesc: "需要审阅",
    legendAcceptedChange: "已接受的修改",
    legendAcceptedDesc: "插入的文本",
    legendDeletionDesc: "删除线文本",
    legendCommentDesc: "行内批注",
    replacedAcross: "已在 {chapters} 中替换 {count} 处。",
    tryAgainHint: "请重试。",
    scopeThisChapter: "本章",
    scopeWholeBook: "整本书",
    keyboardHint: "Enter 发送 · Shift+Enter 换行",
    focusNormalDesc: "全部可见",
    focusFocusedDesc: "侧边栏与顶栏变暗",
    focusParagraphDesc: "高亮当前段落",
    inlineRewrite: "改写",
    inlineImprove: "润色",
    inlineShorten: "缩短",
    inlineExtend: "扩写",
    inlineRevise: "修订",
    inlineMoreDialogue: "多些对话",
    inlineMoreVivid: "更生动",
    inlineMoreFormal: "更正式",
    chapterPlaceholder: "开始写这一章……",
    conflictNewerVersion: "另一方（代理、导入或另一标签页）保存了更新的版本。你的文字仍在本编辑器中 — 请查看后继续保存。",
    offlineKept: "你当前离线。文字保存在本设备，联网后会自动同步。",
    conflictPreserved: "另一版本保留在版本历史中。",
    conflictChangedAgain: "{doc} 再次发生变更",
    conflictDiffUpdated: "差异已更新 — 请再确认一次。",
    versionManual: "手动",
    versionRestore: "恢复",
    versionImport: "导入",
    openSettings: "打开设置",
  ...
  importExportUI: {
    ...
    formatPlainText: "纯文本",
    mergedSuffix: "（已合并）",
    readyChaptersDrafted: "已起草章节",
    readyChaptersEdited: "已编辑章节",
    readyBetaReading: "Beta 试读",
    readyPendingFindings: "待处理发现",
    readyFingerprint: "风格指纹",
    readyStoryBible: "故事圣经",
    readyDraftedDetail: "{done}/{total} 章已起草",
    readyEditedAll: "所有章节均已编辑",
    readyEditedSome: "{count} 章需要编辑审阅",
    readyBetaAll: "所有章节均已通过 Beta 试读",
    readyBetaSome: "{done}/{total} 章通过 Beta 试读",
    readyFindingsNone: "没有未审阅的发现",
    readyFindingsSome: "{count} 条发现待审阅",
    readyFingerprintYes: "已捕捉风格指纹",
    readyFingerprintNo: "没有风格指纹 — AI 的文风可能不一致",
    readyBibleYes: "已创建故事圣经",
    readyBibleNo: "没有故事圣经 — 建议在导出前创建",
    formatDocxDesc: "Microsoft Word 格式，便于编辑与投稿",
    formatPdfDesc: "通过 Typst 引擎输出，具备专业排版，可直接印刷",
    formatEpubDesc: "EPUB3，适用于电子阅读器与数字发行",
    importDocxDesc: "章节识别最准确，保留格式。",
    importMarkdownDesc: "原生格式，自动识别章节标题。",
    importTxtDesc: "按空行或标题拆分章节。",
  },
  ...
  pagesUI: {
    ...
    seriesWide: "整个系列",
    metaNotFound: "未找到",
    metaSnapshot: "{book} — 快照",
    metaEditorialBrief: "{book} — 编辑简报",
    setupFailed: "无法完成设置：{error}",
    setupSavedNoChapter: "设置已保存，但无法打开第一章：{error}",
    alertFindingsNeedReview: "{count} 条发现待审阅",
    alertBetaFailed: "{chapter} 的 Beta 试读未通过 — {book}",
    seriesDuology: "二部曲（2 本）",
    seriesTrilogy: "三部曲（3 本）",
    seriesTetralogy: "四部曲（4 本）",
    seriesPentalogy: "五部曲（5 本）",
    seriesSaga: "系列（6 本以上）",
    seriesOpenEnded: "开放式系列",
    docPlaceholder: "开始写作……",
    conflictSafeHint: "你的修改安全 — 请查看差异并合并。",
    bookLevel: "图书级",
