...
export const EN: UIStrings = {
  ...
  settings: {
    ...
    roleAnalystDesc: "Style analysis, manuscript reading, continuity checking, market analysis.",
    roleCoachDesc: "Writing coach orchestrating multi-step workflows.",
    roleCreativeDesc: "Story architecture, scene planning, creative brainstorming.",
    addKey: "Add Key",
    provider: "Provider",
